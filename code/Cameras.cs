...
namespace SKarts
{
	...
	public class VehicleCamera : Camera
	{
		public override void Update()
		{
			...
			var vehicle = (pawn as SKartsRacer).Vehicle;

			Pos = center;
			Rot = Rotation.FromAxis( Vector3.Up, 0 ) * vehicle.Rotation;

			float distance = 256.0f * pawn.Scale;
			targetPos = Pos + vehicle.Rotation.Right * pawn.Scale;
			targetPos += vehicle.Rotation.Forward * -distance;
